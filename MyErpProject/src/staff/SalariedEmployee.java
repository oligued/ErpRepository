...
public class SalariedEmployee extends Employee
{
	...
	/**
	 * Default constructor. Postcondition: set salary to 0 and call default
	...
	/**
	 * Constructor use to set theName and theSalary. Precondition: theName is
	 * not null and theSalary is nonnegative.
	 */
